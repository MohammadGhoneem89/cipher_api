...
function settlementSearchList(body,JWToken) {

  logger.app.info(body, ' [ Settlement Search ] Settlement Search req : ');
  ...
  if (body) {
    ...
    if (body.data.batchNo && body.data.batchNo !== '') {
      ...
      criteria.push({ 'data.SettlementBatchNo': body.data.batchNo });
    }
...
module.exports = settlementSearchList;
