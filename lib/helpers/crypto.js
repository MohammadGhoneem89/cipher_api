...
function decryptEx(str = '') {
  ...
  console.log(encryptEx("mongodb://localhost:10050/cipherRI"), "EEEEEEEEEENC");
  ...
  try {
    ...
    // console.log(crypt1);
    console.log(JSON.parse(crypt1), "DDDDDDDDDDdEC");
    return JSON.parse(crypt1);
  }
  catch (err) {
    // console.log ("this is the error" + err);
    console.log(JSON.parse(crypt1), "OUTTTTTTTTT");
    return crypt;
  }
}
