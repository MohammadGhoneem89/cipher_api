...
const smiles = ['getProviderCards', 'getMerchantInfo', 'viewOrders', 'viewPendingOrders', 'viewCatalogue', 'viewPoints', 'viewSettlements',
  'viewTransactions', 'getTxCard', 'viewCompletedSettlements', 'viewPendingSettlements', 'placeOrder', 'addItem','settle','requestForSettlement','addMultipleItems','resolveEscrow','viewItem','organizationType'];
