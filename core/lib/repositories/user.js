...
function findPageAndCount(payload) {
  ...
  if (payload.searchCriteria.userID) {
    query.userID = { $regex: RegExp(payload.searchCriteria.userID, 'gi'), $options: 'si' };
  }
  if (payload.searchCriteria.firstName) {
    query.firstName = { $regex: RegExp(payload.searchCriteria.firstName, 'gi'), $options: 'si' };
  }
  if (payload.searchCriteria.lastName) {
    query.lastName = { $regex: RegExp(payload.searchCriteria.lastName, 'gi'), $options: 'si' };
  }
