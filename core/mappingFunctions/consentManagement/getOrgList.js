...
const entityTypeData = require("../org/orgTypeData");
...
let getOrgList = function (payload, UUIDKey, route, callback, JWToken) {
      ...
      global.db.selectWithSort("Entity", where, {
        ...
        if (err) {
          ...
          entityTypeData(function (nameData) {
            ...
            console.log("EntityData Length ============ >>>> ", entityData.length);
